...
class PemberiDonorService {
  static Future<List<PemberiDonor>> getPemberiDonorByEmail(
      String email) async {
  ...
  static Future<List<PemberiDonor>> convertToListPemberiDonor(
      var data) async {
  ...
  static Future<void> deletePemberiDonorById(String idDataPemberiDonor) async {
    String url = base_url + "deleteDataPemberiDonor?idDataPemberiDonor=$idDataPemberiDonor";
